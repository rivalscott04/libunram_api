            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group" id="data_1">
                        <label class="font-normal">Pilih Tanggal</label>
                        <div class="input-group date">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="tgl" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    ...
                                    <div class="row mb-2 p-2">
                                        <div class="col-2" style="background-color: #e7eaec">
                                            {{-- <span class="label label-info"></span> --}}
                                        </div>
                                        <div class="col-6 text-left">
                                            Ruang Serbaguna
